...
These are course notes for [a second-year Programming Paradigms course](https://youtu.be/-0YVTpson98) that focuses on introducing functional programming concepts, first in JavaScript, then introducing type systems through TypeScript, and finally diving in to Haskell.
