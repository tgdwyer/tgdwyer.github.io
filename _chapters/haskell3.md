...
In Haskell this pattern is captured in a type class called [`Functor`](https://soundcloud.com/tim-dwyer-17038309/whatthefunctor-mixdown2), which defines a function called `fmap`.
